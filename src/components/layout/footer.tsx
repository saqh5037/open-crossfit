...
export function Footer() {
  return (
    <footer className="border-t border-gray-800 bg-[#0a0a0a] text-gray-400">
      <div className="container px-4 py-10">
        <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col items-center gap-3 md:items-start">
            ...
            <p className="text-sm">Entrenamiento funcional en Mérida</p>
            <p className="text-xs text-gray-600">EST. 2021</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left">
            ...
            <Link
              href="https://www.google.com/maps?q=GRIZZLYS+CAUCEL"
              target="_blank"
          ...
          <div className="flex flex-col items-center gap-3 md:items-start">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                href="https://www.facebook.com/GrizzlysMerida"
                target="_blank"
                className="flex items-center gap-2 text-sm transition-colors hover:text-primary"
              >
