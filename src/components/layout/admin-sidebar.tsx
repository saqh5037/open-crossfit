...
const navItems = [
  ...
  { href: "/admin/scores/scorecard", label: "Scorecard 26.1", shortLabel: "SC 26.1", icon: FileText, roles: ["owner", "admin", "coach"], quickNav: false },
  { href: "/admin/scores/scorecard-262", label: "Scorecard 26.2", shortLabel: "SC 26.2", icon: FileText, roles: ["owner", "admin", "coach"], quickNav: false },
